 ...
 */
final class Version20230201142011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE genre (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE film ADD CONSTRAINT FK_8244BE22CC2B4B9E FOREIGN KEY (realisateurfilm_id) REFERENCES realisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE film DROP FOREIGN KEY FK_8244BE22CC2B4B9E');
